...
import { SettingRow, DiffersFromOfficialHint } from '../../common';
...
/**
 * The language the user speaks while dictating.
 *
 * Distinct from the two language settings in the section above: those are what
 * Claude writes back and what the interface is written in, and neither says
 * anything about what a microphone should expect to hear.
 */
  ...
  const languageOptions: SelectOption[] = useMemo(() => {
    ...
    return [
      ...
      ...all.map((o) => ({
        ...
        label: o.supported
          ? o.label
          : t('general.voice.speechLanguage.unsupported', { language: o.label }),
      })),
    ];
  }, [t, inherited]);
