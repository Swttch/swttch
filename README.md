...
- [Empty chat tab on Linux](docs/troubleshooting/en/linux-jcef-blank-panel.md) — the chat tab is completely empty on Linux, and the IDE's own Markdown preview is empty too
...
- [Review screen colours](docs/troubleshooting/en/diff-colors-old-ide.md) — the review screen comes out with no colour on IDE 2025.2 and older
...
- **Looking for something to work on?** Check issues labeled [`good first issue`](https://github.com/Swttch/swttch/labels/good%20first%20issue).
- **Have a larger change in mind?** Please [open an issue](https://github.com/Swttch/swttch/issues) first to discuss.
